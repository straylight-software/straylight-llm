    ...
    return function ($copy_prev) {
        return function ($copy_points) {
            ...
            function $tco_loop(inputVal, prev, points) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Schema.Color.Curves (line 149, column 3 - line 156, column 44): " + [ v.constructor.name ]);
            };
            while (!$tco_done) {
    ...
    return function (points) {
        ...
        if (v instanceof Data_Maybe.Just) {
            ...
            if ($73) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Schema.Color.Curves (line 141, column 14 - line 143, column 73): " + [ v1.constructor.name ]);
            };
            return findNext(inputVal)(v.value0.head)(v.value0.tail);
        };
        throw new Error("Failed pattern match at Hydrogen.Schema.Color.Curves (line 137, column 3 - line 144, column 42): " + [ v.constructor.name ]);
    };
};
...
var applyToChannel = function (v) {
    return function (input) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Schema.Color.Curves (line 120, column 6 - line 132, column 32): " + [ v1.constructor.name ]);
    };
};
