...
var snapshot = function (dictShow) {
    ...
    return function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Hydrogen.State.Atom (line 366, column 3 - line 371, column 51): " + [ v1.key.constructor.name ]);
        };
    };
};
var set = function (v) {
            ...
            if (v1.key instanceof Data_Maybe.Just) {
                return function __do() {
                    ...
                    if (v2 instanceof Data_Maybe.Just) {
                        ...
                        throw new Error("Failed pattern match at Hydrogen.State.Atom (line 384, column 11 - line 386, column 34): " + [ v3.constructor.name ]);
                    };
                    throw new Error("Failed pattern match at Hydrogen.State.Atom (line 380, column 7 - line 386, column 34): " + [ v2.constructor.name ]);
                };
            };
            throw new Error("Failed pattern match at Hydrogen.State.Atom (line 376, column 3 - line 386, column 34): " + [ v1.key.constructor.name ]);
        };
    };
};
...
var refreshAtom = function (client) {
    return function (key) {
        return Hydrogen_Query.invalidate(client)(key);
    };
};
...
var queryAtom = function (dictDecodeJson) {
                    ...
                    return function (fetchFn) {
                        var joinWith = function (sep) {
                            return function (arr) {
                                ...
                                throw new Error("Failed pattern match at Hydrogen.State.Atom (line 287, column 22 - line 290, column 56): " + [ v.constructor.name ]);
                            };
                        };
                        var keyToString = joinWith(":");
                        return function __do() {
                            var atomRef = atomWithKey(keyToString(key))(initial)();
                            Effect_Aff.launchAff_(bind1(query1(client)(Hydrogen_Query.defaultQueryOptions(key)(fetchFn)))(function (state) {
                                if (state.data instanceof Hydrogen_Data_RemoteData.Success) {
                                    return liftEffect(set(atomRef)(state.data.value0));
                                };
