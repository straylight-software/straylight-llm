...
var toEither = function (pending) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 227, column 20 - line 231, column 23): " + [ v.constructor.name ]);
    };
};
    ...
    return function (dictShow1) {
        ...
        return {
            show: function (v) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 109, column 1 - line 113, column 50): " + [ v.constructor.name ]);
            }
        };
    };
};
    ...
    return {
        append: function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 169, column 1 - line 177, column 38): " + [ v.constructor.name, v1.constructor.name ]);
            };
        }
    };
};
...
var mapError = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 295, column 1 - line 295, column 77): " + [ v.constructor.name, v1.constructor.name ]);
    };
};
...
var fromEither = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 213, column 1 - line 213, column 55): " + [ v.constructor.name ]);
};
...
var traversableRemoteData = {
    traverse: function (dictApplicative) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 197, column 16 - line 201, column 33): " + [ v.constructor.name ]);
            };
        };
    },
    sequence: function (dictApplicative) {
        ...
        return function (v) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 202, column 14 - line 206, column 33): " + [ v.constructor.name ]);
        };
    },
    Functor0: function () {
...
var fold = function (handlers) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 258, column 17 - line 262, column 34): " + [ v.constructor.name ]);
    };
};
    ...
    bimap: function (v) {
        return function (v1) {
            return function (v2) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 138, column 1 - line 142, column 40): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
            };
        };
    }
};
var applyRemoteData = {
    apply: function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 117, column 1 - line 124, column 30): " + [ v.constructor.name, v1.constructor.name ]);
        };
    },
    Functor0: function () {
        return functorRemoteData;
...
var bindRemoteData = {
    bind: function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 129, column 1 - line 133, column 27): " + [ v.constructor.name, v1.constructor.name ]);
        };
    },
    Apply0: function () {
...
var altRemoteData = {
    alt: function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Data.RemoteData (line 153, column 1 - line 160, column 32): " + [ v.constructor.name, v1.constructor.name ]);
        };
    },
    Functor0: function () {
        return functorRemoteData;
