...
var showHttpMethod = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Runtime.Cmd (line 345, column 10 - line 352, column 25): " + [ v.constructor.name ]);
    }
};
...
var showCmd = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Runtime.Cmd (line 200, column 10 - line 217, column 36): " + [ v.constructor.name ]);
    }
};
var interval = /* #__PURE__ */ (function () {
...
var functorCmd = {
    map: function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Runtime.Cmd (line 180, column 11 - line 197, column 25): " + [ v.constructor.name ]);
        };
    }
};
