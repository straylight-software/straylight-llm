...
var button = function (mods) {
    return function (children) {
        ...
        var content = (function () {
            if (config.loading) {
                return [ loadingSpinner, Hydrogen_Render_Element_HTML.span_([ Hydrogen_Render_Element_Attributes.class_("ml-2") ])(children) ];
            };
            return children;
        })();
        ...
        var baseAttrs = [ Hydrogen_Render_Element_Attributes.class_(allClasses), Hydrogen_Render_Element_Attributes.type_(buttonTypeStr(config.type_)), Hydrogen_Render_Element_Attributes.disabled(config.disabled || config.loading) ];
        var attrs = (function () {
            if (config.onClick instanceof Data_Maybe.Just) {
                return append1(baseAttrs)([ Hydrogen_Render_Element_Events.onClick(config.onClick.value0) ]);
            };
        ...
        return Hydrogen_Render_Element_HTML.button_(attrs)(content);
    };
};
var buttonLink = function (mods) {
    return function (href) {
        return function (children) {
            ...
            return Hydrogen_Render_Element_HTML.a_([ Hydrogen_Render_Element_Attributes.class_(allClasses), Hydrogen_Render_Element_Attributes.href(href) ])(children);
        };
    };
};
export {
