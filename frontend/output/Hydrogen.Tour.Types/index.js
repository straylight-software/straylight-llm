...
var progressPercent = function (p) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 425, column 1 - line 425, column 35): " + [ p.constructor.name ]);
};
...
var oppositeSide = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 317, column 16 - line 321, column 16): " + [ v.constructor.name ]);
};
var mkTourId = TourId;
var mkTestId = TestId;
var mkStepId = StepId;
var mkSelector = function (s) {
    ...
    var startsWithDigit = function (str) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 142, column 27 - line 144, column 23): " + [ v.constructor.name ]);
    };
...
var genericTourPhase = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 373, column 1 - line 373, column 56): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var genericTarget = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 119, column 1 - line 119, column 50): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var genericSide = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 280, column 1 - line 280, column 46): " + [ x.constructor.name ]);
    },
    from: function (x) {
        if (x instanceof Top) {
            return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
...
var genericAriaRole = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 223, column 1 - line 223, column 54): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var genericAlignment = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 293, column 1 - line 293, column 56): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var ariaRoleString = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Tour.Types (line 230, column 18 - line 265, column 21): " + [ v.constructor.name ]);
};
export {
    TourId,
    mkTourId,
