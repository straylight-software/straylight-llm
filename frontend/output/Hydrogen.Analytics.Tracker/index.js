...
var showWebVitalMetric = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Analytics.Tracker (line 370, column 10 - line 376, column 39): " + [ v.constructor.name ]);
    }
};
...
var setPrivacyMode = function (tracker) {
    return function (mode) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Analytics.Tracker (line 509, column 31 - line 514, column 50): " + [ mode.constructor.name ]);
    };
};
...
var maybeInsert = function (key) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Analytics.Tracker (line 619, column 19 - line 621, column 22): " + [ v.constructor.name ]);
    };
};
var loadRemoteConfig = function (tracker) {
    return function (url) {
        return query(tracker.queryClient)(Hydrogen_Query.defaultQueryOptions([ "analytics", "config", url ])($foreign.fetchConfigImpl(url)));
    };
};
var isTracking = function (tracker) {
    return Effect_Ref.read(tracker.isEnabled);
};
var invalidateConfig = function (tracker) {
    return Hydrogen_Query.invalidate(tracker.queryClient)([ "analytics", "config" ]);
};
...
var trackVital = function (tracker) {
    return function (metric) {
        var v = (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Analytics.Tracker (line 391, column 25 - line 397, column 28): " + [ metric.constructor.name ]);
        })();
...
var createWithConfig = function (config) {
    return function __do() {
        ...
        (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Analytics.Tracker (line 183, column 3 - line 185, column 25): " + [ config.flushInterval.constructor.name ]);
        })();
        return tracker;
    };
};
