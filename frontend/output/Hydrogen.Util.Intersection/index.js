...
var readBoolRef = Effect_Ref.read;
...
var onEnterViewport = function (element) {
    return function (callback) {
        return function __do() {
            var wasVisibleRef = newBoolRef(false)();
            return observe(element)(defaultConfig)(function (entry) {
                return function __do() {
                    var wasVisible = readBoolRef(wasVisibleRef)();
                    when(entry.isIntersecting && !wasVisible)(callback)();
                    return writeBoolRef(wasVisibleRef)(entry.isIntersecting)();
                };
            })();
        };
    };
