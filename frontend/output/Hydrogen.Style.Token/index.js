...
var zIndex = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Style.Token (line 464, column 10 - line 471, column 20): " + [ v.constructor.name ]);
};
var spacingPx = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Style.Token (line 248, column 13 - line 283, column 13): " + [ v.constructor.name ]);
};
var spacing = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Style.Token (line 209, column 11 - line 244, column 18): " + [ v.constructor.name ]);
};
var sizeClass = function (prefix) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Style.Token (line 520, column 20 - line 529, column 50): " + [ v.constructor.name ]);
    };
};
...
var shadow = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Style.Token (line 435, column 10 - line 443, column 32): " + [ v.constructor.name ]);
};
var radius = function (v) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Style.Token (line 404, column 10 - line 413, column 32): " + [ v.constructor.name ]);
};
