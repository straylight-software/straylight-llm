    ...
    return function (v) {
        return function (handler) {
            return subscribeWithFilter(bus)(function (v1) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Event.Bus (line 391, column 19 - line 393, column 27): " + [ v1.constructor.name ]);
            });
        };
    };
};
    ...
    return function (event) {
        return function __do() {
            ...
            return Effect_Ref.modify_(function (arr) {
                ...
                var $57 = Data_Array.length(newArr) > history.maxSize;
                if ($57) {
...
var getHistory = function (bus) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Event.Bus (line 324, column 18 - line 326, column 21): " + [ bus.history.constructor.name ]);
};
    ...
    return function (event) {
        var shouldHandle = function (e) {
            return function (sub) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Event.Bus (line 218, column 24 - line 220, column 18): " + [ sub.filter.constructor.name ]);
            };
        };
        var for_ = function (arr) {
            return function (f) {
        ...
        return function __do() {
            (function () {
                ...
                throw new Error("Failed pattern match at Hydrogen.Event.Bus (line 193, column 3 - line 195, column 25): " + [ bus.history.constructor.name ]);
            })();
...
var clearHistory = function (bus) {
    ...
    throw new Error("Failed pattern match at Hydrogen.Event.Bus (line 330, column 20 - line 332, column 23): " + [ bus.history.constructor.name ]);
};
