...
var trackExposure = function (provider) {
    return function (exp) {
        return function (variantId) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 312, column 3 - line 314, column 25): " + [ provider.config.onExposure.constructor.name ]);
        };
    };
};
...
var showFlagValue = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 141, column 10 - line 145, column 36): " + [ v.constructor.name ]);
    }
};
var showFlag = {
    show: function (v) {
    ...
    return function (f) {
        return function (val) {
            return when(provider.config.trackExposures)((function () {
                ...
                throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 252, column 5 - line 254, column 27): " + [ provider.config.onExposure.constructor.name ]);
            })());
        };
    };
};
...
var evaluateCondition = function (condition) {
    return function (ctx) {
        ...
        if (condition instanceof Percentage) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 409, column 5 - line 411, column 23): " + [ ctx.userId.constructor.name ]);
        };
        if (condition instanceof UserIds) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 414, column 5 - line 416, column 23): " + [ ctx.userId.constructor.name ]);
        };
        if (condition instanceof UserAttribute) {
            ...
            throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 419, column 5 - line 421, column 23): " + [ v.constructor.name ]);
        };
        ...
        throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 404, column 35 - line 427, column 75): " + [ condition.constructor.name ]);
    };
};
...
var evaluateFlag = function (def) {
    return function (ctx) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 259, column 3 - line 261, column 32): " + [ v.constructor.name ]);
    };
};
var eqFlagValue = {
    eq: function (x) {
    ...
    return function (f) {
        return function __do() {
            ...
            if (v instanceof Data_Maybe.Nothing) {
                ...
                throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 233, column 7 - line 238, column 32): " + [ v1.constructor.name ]);
            };
            throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 225, column 3 - line 238, column 32): " + [ v.constructor.name ]);
        };
    };
};
var getFlagState = function (provider) {
    return function (f) {
        return function __do() {
            ...
            throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 574, column 3 - line 586, column 10): " + [ v.constructor.name ]);
        };
    };
};
        ...
        return function (defaultVal) {
            return function (extract) {
                return function __do() {
                    ...
                    throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 244, column 10 - line 246, column 26): " + [ v.constructor.name ]);
                };
            };
        };
    };
    ...
    return function (f) {
        return function __do() {
            ...
            (function () {
                ...
                throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 498, column 3 - line 500, column 25): " + [ maybeVal.constructor.name ]);
            })();
            return when(provider.config.persistOverrides)($foreign.persistOverrides(provider.overrides))();
        };
    };
        ...
        var go = function ($copy_acc) {
            return function ($copy_arr) {
                ...
                function $tco_loop(acc, arr) {
                    ...
                    if (v instanceof Data_Maybe.Just) {
                        var $116 = normalized < acc + v.value0.head.weight;
                        if ($116) {
                            $tco_done = true;
                    ...
                    throw new Error("Failed pattern match at Hydrogen.Feature.Flags (line 322, column 18 - line 327, column 38): " + [ v.constructor.name ]);
                };
                while (!$tco_done) {
