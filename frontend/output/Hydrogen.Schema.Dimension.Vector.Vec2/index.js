...
var lerpVec2 = function (t) {
    return function (v) {
        return function (v1) {
            return new Vec2(Hydrogen_Math_Core_Interpolation.lerp(v.value0)(v1.value0)(t), Hydrogen_Math_Core_Interpolation.lerp(v.value1)(v1.value1)(t));
        };
    };
};
...
var lengthVec2 = function (v) {
    return Hydrogen_Math_Core_Arithmetic.sqrt(lengthSquaredVec2(v));
};
...
var angleVec2 = function (v) {
    return Hydrogen_Math_Core_Trigonometry.atan2(v.value1)(v.value0);
};
