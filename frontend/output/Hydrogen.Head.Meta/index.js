...
var setOgTags = function (tags) {
    return function __do() {
        ...
        (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 139, column 3 - line 141, column 25): " + [ tags.image.constructor.name ]);
        })();
        (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 142, column 3 - line 144, column 25): " + [ tags.url.constructor.name ]);
        })();
        (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 145, column 3 - line 147, column 25): " + [ tags.type_.constructor.name ]);
        })();
        ...
        throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 148, column 3 - line 150, column 25): " + [ tags.siteName.constructor.name ]);
    };
};
var setTwitterCard = function (card) {
    return function __do() {
        ...
        (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 162, column 3 - line 164, column 25): " + [ card.image.constructor.name ]);
        })();
        (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 165, column 3 - line 167, column 25): " + [ card.site.constructor.name ]);
        })();
        ...
        throw new Error("Failed pattern match at Hydrogen.Head.Meta (line 168, column 3 - line 170, column 25): " + [ card.creator.constructor.name ]);
    };
};
