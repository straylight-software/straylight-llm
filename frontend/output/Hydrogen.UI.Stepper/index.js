...
var stepperItem = function (status) {
    return function (stepNumber) {
        return function (label) {
            ...
            return Hydrogen_Render_Element.div_([ Hydrogen_Render_Element.class_("flex items-center gap-3") ])([ Hydrogen_Render_Element.div_([ Hydrogen_Render_Element.class_("flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm " + classes.circle) ])([ Hydrogen_Render_Element.text((function () {
                if (status instanceof Complete) {
                    return "\u2713";
                };
                return stepNumber;
            })()) ]), Hydrogen_Render_Element.span_([ Hydrogen_Render_Element.class_("text-sm " + classes.text) ])([ Hydrogen_Render_Element.text(label) ]) ]);
        };
    };
};
