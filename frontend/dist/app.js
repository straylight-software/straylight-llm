...
(() => {
  ...
  var decodeJson1 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonInt))(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons1({
    reflectSymbol: function() {
      return "ownedBy";
    }
  })()())(objectIsSymbol)()())({
  ...
  var mkUrl = function(cfg) {
    return function(path) {
      return cfg.baseUrl + (":" + (show3(cfg.port) + path));
    };
  };
  var healthCheck = function(cfg) {
    return bind6(get3(json)(mkUrl(cfg)("/health")))(function(result) {
  ...
  var getModels = function(cfg) {
    return bind6(get3(json)(mkUrl(cfg)("/v1/models")))(function(result) {
      return pure11(function() {
        if (result instanceof Left) {
          return new Left(printError(result.value0));
        }
  ...
  var decodeJsonCoeffect = {
    decodeJson: function(json2) {
      ...
      if (v instanceof Just) {
        ...
        ;
        if (v1 instanceof Just) {
          return bind15(decodeString(v1.value0))(function(ty) {
            if (ty === "pure") {
            ...
            if (ty === "auth") {
              ...
              if (v2 instanceof Just) {
                return map25(Auth.create)(decodeString(v2.value0));
              }
              ;
              if (v2 instanceof Nothing) {
                return new Left(MissingValue.value);
            ...
            if (ty === "sandbox") {
              ...
              if (v2 instanceof Just) {
                return map25(Sandbox.create)(decodeString(v2.value0));
              }
              ;
              if (v2 instanceof Nothing) {
                return new Left(MissingValue.value);
            ...
            if (ty === "filesystem") {
              var v2 = lookup3("path")(v.value0);
              if (v2 instanceof Just) {
                return map25(Filesystem.create)(decodeString(v2.value0));
              }
              ;
              if (v2 instanceof Nothing) {
                return new Left(MissingValue.value);
            ...
            if (ty === "combined") {
              ...
              if (v2 instanceof Just) {
                return map25(Combined.create)(decodeArray(decodeJson(decodeJsonCoeffect))(v2.value0));
              }
              ;
              if (v2 instanceof Nothing) {
                return new Left(MissingValue.value);
  ...
  var decodeJson22 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons22(gDecodeJsonCons3)({
    reflectSymbol: function() {
      return "scope";
    }
  })()())({
  ...
  })()())())))(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(decodeJsonCoeffect)))(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons22(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(gDecodeJsonCons3)({
    reflectSymbol: function() {
      return "path";
    }
  })()())({
  ...
  var getProof = function(cfg) {
    return function(requestId) {
      return bind6(get3(json)(mkUrl(cfg)("/v1/proof/" + requestId)))(function(result) {
        return pure11(function() {
          if (result instanceof Left) {
            return new Left(printError(result.value0));
          }
  ...
  var iconSm = function(name16) {
    return img([src9("icons/" + (name16 + ".svg")), classes(map26(ClassName)(["icon", "icon-sm"])), attr2("alt")(name16)]);
  };
  var icon = function(name16) {
    return img([src9("icons/" + (name16 + ".svg")), class_("icon"), attr2("alt")(name16)]);
  };

  // output/Straylight.Components.HealthStatus/index.js
  var identity10 = /* @__PURE__ */ identity(categoryFn);
  var render = function(state3) {
    return div2([class_("dashboard-panel")])([div2([class_("panel-header")])([icon("gauge"), span3([class_("panel-title")])([text5("Gateway Health")])]), div2([class_("panel-body")])([function() {
      if (state3.health instanceof Nothing) {
        return div2([class_("status-card error")])([div2([class_("status-indicator error")])([]), div2([class_("status-text")])([div2([class_("status-label")])([text5("Status")]), div2([class_("status-value")])([text5("Disconnected")])])]);
      }
      ;
      if (state3.health instanceof Just) {
        return div2([class_("health-grid")])([div2([class_("status-card success")])([div2([class_("status-indicator success")])([]), div2([class_("status-text")])([div2([class_("status-label")])([text5("Status")]), div2([class_("status-value")])([text5(state3.health.value0.status)])])]), div2([class_("status-card")])([div2([class_("status-text")])([div2([class_("status-label")])([text5("Version")]), div2([class_("status-value mono")])([text5(state3.health.value0.version)])])]), div2([class_("status-card")])([div2([class_("status-text")])([div2([class_("status-label")])([text5("Architecture")]), div2([class_("status-value")])([text5("aleph cube")])])]), div2([class_("status-card")])([div2([class_("status-text")])([div2([class_("status-label")])([text5("Effects")]), div2([class_("status-value")])([text5("GatewayM graded monad")])])])]);
      }
      ;
      throw new Error("Failed pattern match at Straylight.Components.HealthStatus (line 39, column 11 - line 75, column 18): " + [state3.health.constructor.name]);
    }()])]);
  };
  ...
  var renderModel = function(model) {
    return div2([class_("model-item")])([div2([class_("model-id")])([text5(model.id)]), div2([class_("model-meta")])([span3([class_("model-owner")])([text5(model.ownedBy)])])]);
  };
  var render2 = function(state3) {
    return div2([class_("dashboard-panel")])([div2([class_("panel-header")])([icon("list-checks"), span3([class_("panel-title")])([text5("Available Models")]), function() {
      if (state3.models instanceof Nothing) {
        return text5("");
      }
      ;
      if (state3.models instanceof Just) {
        return span3([class_("panel-badge")])([text5(show4(length3(state3.models.value0.data)) + " models")]);
      }
      ;
      throw new Error("Failed pattern match at Straylight.Components.ModelsPanel (line 38, column 11 - line 41, column 68): " + [state3.models.constructor.name]);
    }()]), div2([class_("panel-body")])([function() {
      if (state3.models instanceof Nothing) {
        return div2([class_("empty-state")])([text5("No models loaded")]);
      }
      ;
      if (state3.models instanceof Just) {
        return div2([class_("models-list")])(map27(renderModel)(state3.models.value0.data));
      }
      ;
      throw new Error("Failed pattern match at Straylight.Components.ModelsPanel (line 44, column 11 - line 50, column 41): " + [state3.models.constructor.name]);
    }()])]);
  };
  ...
  // output/Straylight.Components.ProofViewer/index.js
  ...
  var renderNetworkAccess = function(na) {
    return div2([class_("access-item")])([div2([class_("access-main")])([span3([class_("access-method")])([text5(na.method)]), span3([class_("access-url")])([text5(na.url)])]), div2([class_("access-meta")])([span3([class_("access-time")])([text5(na.timestamp)])])]);
  };
  var renderCoeffect = function(coeff) {
    var coeffectLabel = function(v) {
      ...
      if (v instanceof Combined) {
        return "Combined[" + (show5(length3(v.value0)) + "]");
      }
      ;
    ...
    return div2([class_("coeffect-badge")])([text5(coeffectLabel(coeff))]);
  };
  var renderAuthUsage = function(au) {
    ...
    }()]), div2([class_("access-meta")])([span3([class_("access-time")])([text5(au.timestamp)])])]);
  };
  var renderProof = function(proof) {
    var sigText = function() {
      if (proof.signature instanceof Just) {
        return "Signed";
      }
      ;
      if (proof.signature instanceof Nothing) {
        return "Unsigned";
      }
      ;
    ...
    return div2([class_("proof-details")])([div2([class_("proof-header")])([div2([class_("proof-id")])([span3([class_("proof-label")])([text5("Build ID")]), span3([class_("proof-value mono")])([text5(proof.buildId)])]), div2([class_("proof-sig " + sigClass)])([iconSm(sigIcon), text5(sigText)])]), div2([class_("proof-section")])([div2([class_("proof-section-header")])([text5("Timing")]), div2([class_("proof-grid")])([div2([class_("proof-cell")])([span3([class_("proof-label")])([text5("Start")]), span3([class_("proof-value mono")])([text5(proof.startTime)])]), div2([class_("proof-cell")])([span3([class_("proof-label")])([text5("End")]), span3([class_("proof-value mono")])([text5(proof.endTime)])])])]), div2([class_("proof-section")])([div2([class_("proof-section-header")])([text5("Coeffects"), span3([class_("badge")])([text5(show5(length3(proof.coeffects)))])]), div2([class_("coeffect-list")])(map28(renderCoeffect)(proof.coeffects))]), function() {
      var $21 = $$null2(proof.networkAccess);
      if ($21) {
        return text5("");
      }
      ;
      return div2([class_("proof-section")])([div2([class_("proof-section-header")])([text5("Network Access"), span3([class_("badge")])([text5(show5(length3(proof.networkAccess)))])]), div2([class_("access-list")])(map28(renderNetworkAccess)(proof.networkAccess))]);
    }(), function() {
      var $22 = $$null2(proof.authUsage);
      if ($22) {
        return text5("");
      }
      ;
      return div2([class_("proof-section")])([div2([class_("proof-section-header")])([text5("Auth Usage"), span3([class_("badge")])([text5(show5(length3(proof.authUsage)))])]), div2([class_("access-list")])(map28(renderAuthUsage)(proof.authUsage))]);
    }(), div2([class_("proof-section")])([div2([class_("proof-section-header")])([text5("Hashes")]), div2([class_("hash-item")])([span3([class_("hash-label")])([text5("Derivation")]), code([class_("hash-value")])([text5(proof.derivationHash)])]), div2([class_("hash-list")])(map28(renderOutputHash)(proof.outputHashes))])]);
  };
  var render3 = function(state3) {
    return div2([class_("dashboard-panel")])([div2([class_("panel-header")])([icon("git-compare"), span3([class_("panel-title")])([text5("Discharge Proofs")])]), div2([class_("panel-body")])([div2([class_("proof-search")])([div2([class_("search-label")])([text5("Enter a request ID to view its discharge proof")]), div2([class_("search-input-wrap")])([input([type_19(InputText.value), class_("search-input"), placeholder3("request-id-here"), value14(state3.proofId)]), button([class_("btn")])([text5("Lookup")])])]), function() {
      if (state3.proof instanceof Nothing) {
      ...
      ;
      if (state3.proof instanceof Just) {
        return renderProof(state3.proof.value0);
      }
      ;
      throw new Error("Failed pattern match at Straylight.Components.ProofViewer (line 54, column 11 - line 64, column 36): " + [state3.proof.constructor.name]);
    }()])]);
  };
  ...
  var RefreshHealth = /* @__PURE__ */ function() {
    function RefreshHealth2() {
    }
    ;
    RefreshHealth2.value = new RefreshHealth2();
    return RefreshHealth2;
  }();
  var RefreshModels = /* @__PURE__ */ function() {
    function RefreshModels2() {
    }
    ;
    RefreshModels2.value = new RefreshModels2();
    return RefreshModels2;
  }();
  ...
  var LookupProof = /* @__PURE__ */ function() {
    function LookupProof2() {
    }
    ;
    LookupProof2.value = new LookupProof2();
    return LookupProof2;
  }();
  var renderTitlebar = function(v) {
    return div2([class_("titlebar")])([div2([class_("titlebar-left")])([button([class_("titlebar-btn")])([icon("menu")])]), div2([class_("titlebar-center")])([text5("straylight gateway")]), div2([class_("titlebar-right")])([button([class_("titlebar-btn")])([icon("settings")])])]);
  };
  var renderFooter = function(state3) {
    var connectionStatus = function() {
      ...
      ;
      throw new Error("Failed pattern match at Straylight.App (line 175, column 22 - line 177, column 23): " + [state3.health.constructor.name]);
    }();
    return div2([class_("footer")])([div2([class_("footer-left")])([span3([class_("footer-status")])([span3([class_("status-dot " + connectionStatus)])([]), text5(function() {
      if (state3.health instanceof Just) {
        return "v" + state3.health.value0.version;
      }
      ;
      if (state3.health instanceof Nothing) {
        return "disconnected";
      ...
      ;
      throw new Error("Failed pattern match at Straylight.App (line 166, column 25 - line 168, column 42): " + [state3.health.constructor.name]);
    }())])]), div2([class_("footer-right")])([text5("aleph cube architecture")])]);
  };
  var handleAction = function(dictMonadAff) {
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return discard4(liftEffect7(dismiss))(function() {
          return discard4(handleAction(dictMonadAff)(RefreshHealth.value))(function() {
      ...
      if (v instanceof RefreshHealth) {
        return bind7(get4)(function(state3) {
          return bind7(liftAff2(healthCheck(state3.config)))(function(result) {
            if (result instanceof Left) {
              return modify_3(function(v1) {
                var $61 = {};
                for (var $62 in v1) {
            ...
            if (result instanceof Right) {
              return modify_3(function(v1) {
                ...
                ;
                $65.health = new Just(result.value0);
      ...
      if (v instanceof RefreshModels) {
        return bind7(get4)(function(state3) {
          return bind7(liftAff2(getModels(state3.config)))(function(result) {
            if (result instanceof Left) {
              return modify_3(function(v1) {
                var $70 = {};
                for (var $71 in v1) {
                ...
                ;
                $70.error = new Just(result.value0);
                $70.models = Nothing.value;
                return $70;
              });
            }
            ;
            if (result instanceof Right) {
              return modify_3(function(v1) {
                ...
                ;
                $74.models = new Just(result.value0);
                $74.error = Nothing.value;
                return $74;
              });
            }
            ;
        ...
        return bind7(get4)(function(state3) {
          ...
          if ($82) {
            return modify_3(function(v1) {
              ...
              ;
              $83.error = new Just("Enter a request ID");
              return $83;
            });
          }
          ;
          return bind7(liftAff2(getProof(state3.config)(state3.proofId)))(function(result) {
            if (result instanceof Left) {
              return modify_3(function(v1) {
                var $87 = {};
                for (var $88 in v1) {
                ...
                ;
                $87.error = new Just(result.value0);
                $87.proof = Nothing.value;
                return $87;
              });
            }
            ;
            if (result instanceof Right) {
              return modify_3(function(v1) {
                ...
                ;
                $91.proof = new Just(result.value0);
                $91.error = Nothing.value;
                return $91;
              });
            }
            ;
  ...
  var eq12 = /* @__PURE__ */ eq(eqTab);
  var renderSidebar = function(state3) {
    var navItem = function(tab) {
      return function(iconName) {
        return function(label5) {
          return function(activeTab) {
            return button([classes(map29(ClassName)(append12(["nav-item"])(function() {
              var $97 = eq12(tab)(activeTab);
              if ($97) {
                return ["active"];
              }
              ;
            ...
            })])([icon(iconName), span3([class_("nav-label")])([text5(label5)])]);
          };
        };
      };
    };
    return div2([class_("sidebar")])([div2([class_("sidebar-label")])([text5("Dashboard")]), div2([class_("sidebar-nav")])([navItem(Health.value)("gauge")("Health")(state3.activeTab), navItem(Models.value)("list-checks")("Models")(state3.activeTab), navItem(Proofs.value)("git-compare")("Proofs")(state3.activeTab)])]);
  };
  ...
  var renderMain = function(dictMonadAff) {
    ...
    return function(state3) {
      return div2([class_("thread")])([div2([class_("thread-content")])([div2([class_("messages dashboard-content")])([function() {
        if (state3.activeTab instanceof Health) {
          return slot1(_healthStatus)(unit)(component1)({
            health: state3.health
          })(absurd);
        }
        ;
        if (state3.activeTab instanceof Models) {
          return slot22(_modelsPanel)(unit)(component22)({
            models: state3.models
          })(absurd);
        }
        ;
        if (state3.activeTab instanceof Proofs) {
          return slot3(_proofViewer)(unit)(component32)({
            proof: state3.proof,
            proofId: state3.proofId
          })(absurd);
        }
        ;
        throw new Error("Failed pattern match at Straylight.App (line 143, column 15 - line 149, column 72): " + [state3.activeTab.constructor.name]);
      }()])]), function() {
        ...
        if (state3.error instanceof Just) {
          return div2([class_("error-toast")])([span3([class_("error-toast-text")])([text5(state3.error.value0)])]);
        }
        ;
        throw new Error("Failed pattern match at Straylight.App (line 152, column 7 - line 157, column 14): " + [state3.error.constructor.name]);
      }()]);
    };
  };
  var render4 = function(dictMonadAff) {
    ...
    return function(state3) {
      return div2([class_("layout dashboard-layout")])([renderTitlebar(state3), renderSidebar(state3), renderMain1(state3), renderFooter(state3)]);
    };
  };
    ...
    return mkComponent({
      initialState: function(v) {
        return {
          ...
          health: Nothing.value,
          models: Nothing.value,
          proofId: "",
          proof: Nothing.value,
          error: Nothing.value
        };
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ discard(discardUnit)(bindAff)(awaitLoad)(function() {
    return bind8(selectElement("#app"))(function(mel) {
      ...
      if (mel instanceof Just) {
        return $$void7(runUI2(component5)(unit)(mel.value0));
      }
      ;
